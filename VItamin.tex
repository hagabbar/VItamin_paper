...
posterior estimates on 4 parameters (this may be extended up to 15 parameters) of a detected \ac{GW} event on the order of less than 
1 microsecond, a 6 order of magnitude speed-up over
