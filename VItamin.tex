...
sensitive~\cite{Searle_paper} but computationally costly Bayesian inference
approaches~\cite{1409.7215}.
%
% rationale
%
For \ac{BBH} signals, existing \ac{GW} analyses can take $\mathcal{O}(10^{5} -
10^{6}\:\textrm{seconds})$ to complete~\cite{1409.7215} and for \ac{BNS}
...
method for alerting \ac{EM} follow-up observers~\cite{bayestar_paper}, can
...
analysis tools such as Bayestar~\cite{1508.03634}. The predicted number of
